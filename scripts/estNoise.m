...
% This function infers the noise in a  hyperspectral data set, by assuming 
% that the  reflectance at a given band is well modelled  by a linear 
% regression on the remaining bands. For details see 
%
...
%
% Input:
%    r -> LxN matrix with the hyperspectral data set, where 
%          L is the number of bands  and N is the number of pixels
%
%
...
% ------------------------------------------------------------------------
% Output
%    w  ->  Noise estimates for every pixel (LxN)
...
%
% -----------------------------------------------------------------------
% Copyright (2008): Jos� Nascimento and Jose Bioucas-Dias
% 
